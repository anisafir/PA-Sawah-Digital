...
export const uploadToCloudinary = async (imageUri) => {
  if (!imageUri) {
    console.error('Image URI kosong atau tidak valid:', imageUri);
    return null;
  }
  ...
  console.log('Mengunggah gambar ke Cloudinary dengan URI:', imageUri);
  ...
  try {
    ...
    console.log('Status respons Cloudinary:', res.status);
    console.log('Isi respons Cloudinary:', text);

    if (!res.ok) {
      console.error('Gagal upload ke Cloudinary:', text);
      return null;
    }
    ...
    console.error('Upload gagal (network atau lainnya):', err.message);
    return null;
  }
};
